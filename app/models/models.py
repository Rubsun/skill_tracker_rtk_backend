...
class CourseContent(Base):
    ...
    Attributes:
        ...
        content_type (ContentTypeEnum): The type of the content (task or theory), which can be associated with the course.
        deadline (datetime): The deadline for the task (if the content is a task).
        status (TaskStatusEnum): The status of the task (e.g., 'pending', 'incorrect', 'done').
