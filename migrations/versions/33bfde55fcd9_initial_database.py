...
Revision ID: 33bfde55fcd9
Revises: 
Create Date: 2025-05-30 14:59:57.353171
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('content_type', sa.Enum('task', 'theory', name='contenttypeenum'), nullable=False),
    sa.Column('deadline', sa.DateTime(timezone=True), nullable=False),
    ...
    sa.ForeignKeyConstraint(['course_id'], ['public.courses.id'], name=op.f('fk_course_contents_course_id_courses'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['task_id'], ['public.tasks.id'], name=op.f('fk_course_contents_task_id_tasks'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['theory_id'], ['public.theories.id'], name=op.f('fk_course_contents_theory_id_theories'), ondelete='CASCADE'),
    ...
    sa.CheckConstraint('progress >= 0.0 AND progress <= 100.0', name=op.f('ck_course_employees_chk_course_progress_range')),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('course_content_id', sa.Uuid(), nullable=False),
    sa.Column('user_id', sa.Uuid(), nullable=False),
    sa.ForeignKeyConstraint(['course_content_id'], ['public.course_contents.id'], name=op.f('fk_comments_course_content_id_course_contents'), ondelete='CASCADE'),
...
def downgrade() -> None:
    ...
    op.drop_table('course_contents', schema='public')
