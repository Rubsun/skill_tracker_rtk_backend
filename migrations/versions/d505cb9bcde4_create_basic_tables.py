...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['task_id'], ['public.tasks.id'], name=op.f('fk_contents_task_id_tasks'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['theory_id'], ['public.theories.id'], name=op.f('fk_contents_theory_id_theories'), ondelete='SET NULL'),
