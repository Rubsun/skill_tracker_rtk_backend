...
from skill_tracker.services.ai_service import analyze_text
from skill_tracker.utils.metrics import TOTAL_MESSAGES_PRODUCED
...
@celery_app.task
def process_notification_analysis(notification_id: UUID):
    async def inner():
